...
char intro() //Introduction visuelle presentant les differentes touches
{
  char digit = 0;
  ...
  printf ("\t\t\t* -les arbres sont les 2 et les 3  *\n");
  printf ("\t\t\t* sont des rochers                 *\n");
  printf ("\t\t\t* -les pièces sont des 5           *\n");
  printf ("\t\t\t* -la clef est un 4                *\n");
  printf ("\t\t\t* -et le tresors est un 9          *\n");
...
void def_tableau() //Definition du tableau representant la carte
{
  int i = 0;
